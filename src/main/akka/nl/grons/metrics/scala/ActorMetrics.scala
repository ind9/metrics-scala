...
trait ReceiveCounterActor extends Actor { self: InstrumentedBuilder =>
  ...
  def receiveCounterName: MetricName = MetricName(getClass).resolve("receiveCounter")
...
trait ReceiveTimerActor extends Actor { self: InstrumentedBuilder =>
  ...
  def receiveTimerName: MetricName = MetricName(getClass).resolve("receiveTimer")
...
trait ReceiveExceptionMeterActor extends Actor { self: InstrumentedBuilder =>
  ...
  def receiveExceptionMeterName: MetricName = MetricName(getClass).resolve("receiveExceptionMeter")
